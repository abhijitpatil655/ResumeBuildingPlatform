...
import {ArrowLeftIcon, AwardIcon, Briefcase, ChevronLeft, ChevronRight, DownloadIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2Icon, Sparkle, User } from 'lucide-react';
...
const ResumeBuilder = () => {
    ...
    const saveResume = async()=>{
        try {
            ...
            //remove image form updated resume data
